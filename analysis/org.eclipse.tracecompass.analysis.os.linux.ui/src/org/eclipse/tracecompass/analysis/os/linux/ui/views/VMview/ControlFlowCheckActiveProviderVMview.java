 ...
 * @since 1.0
 */
public class ControlFlowCheckActiveProviderVMview implements ITimeGraphEntryActiveProvider {
     ...
     *            Button tooltip
     */
    public ControlFlowCheckActiveProviderVMview(String label, String tooltip) {
        fLabel = label;
        fTooltip = tooltip;
    }
    ...
    public boolean isActive(ITimeGraphEntry element) {
        if (element instanceof ControlFlowEntryVMview) {
            ControlFlowEntryVMview cfe = (ControlFlowEntryVMview) element;
