 ...
 */
public class ControlFlowPresentationProviderVMview extends TimeGraphPresentationProvider {
    private enum State {
        ...
        NON_ROOT       (new RGB(153,216,201)),
        ROOT       (new RGB(44,162,95));
     ...
     * Default constructor
     */
    public ControlFlowPresentationProviderVMview() {
    ...
    private static State getMatchingState(int status) {
        ...
        case StateValues.PROCESS_STATUS_NON_ROOT:
            return State.NON_ROOT;
        case StateValues.PROCESS_STATUS_ROOT:
            return State.ROOT;
        case StateValues.PROCESS_STATUS_PREEMPTED:
    ...
    public Map<String, String> getEventHoverToolTipInfo(ITimeEvent event) {
        ...
        if (!(event instanceof TimeEvent) || !((TimeEvent) event).hasValue() ||
                !(event.getEntry() instanceof ControlFlowEntryVMview)) {
            return retMap;
        }
        ControlFlowEntryVMview entry = (ControlFlowEntryVMview) event.getEntry();
