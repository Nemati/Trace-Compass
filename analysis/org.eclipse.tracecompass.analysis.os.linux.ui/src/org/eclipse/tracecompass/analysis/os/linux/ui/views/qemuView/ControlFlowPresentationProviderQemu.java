 ...
 */
public class ControlFlowPresentationProviderQemu extends TimeGraphPresentationProvider {
    private enum State {
     ...
     * Default constructor
     */
    public ControlFlowPresentationProviderQemu() {
    ...
    public Map<String, String> getEventHoverToolTipInfo(ITimeEvent event) {
        ...
        if (!(event instanceof TimeEvent) || !((TimeEvent) event).hasValue() ||
                !(event.getEntry() instanceof ControlFlowEntryQemu)) {
            return retMap;
        }
        ControlFlowEntryQemu entry = (ControlFlowEntryQemu) event.getEntry();
